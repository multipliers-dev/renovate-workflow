...
**Policy sync note:** When [policy-rubric.md](../.cursor/skills/renovate-classifier/policy-rubric.md) or [renovate.json](../renovate.json) changes, update [renovate-policy.yml](renovate-policy.yml) in the same PR.
...
| --------------------------- | -------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `pr_ci_green`               | always                           | PR check runs green via `get_check_runs`; maps to `CI` / `test` per [ci.yml](../.github/workflows/ci.yml)                                                                              | `gh pr checks <N>` — all required checks passing                                                                                                                                                                                                                                                                                       |
