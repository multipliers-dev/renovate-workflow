...
Use [`evaluateEffectiveExecutionAuthority`](node_modules/renovate-workflow/scripts/lib/renovate-guardrails.ts) as the sole authority derivation for the investigation-approved path:
