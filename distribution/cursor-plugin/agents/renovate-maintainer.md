...
2. **Derive authority** — call `evaluateEffectiveExecutionAuthority(packet, policy, { overlay, humanApprovalModifier })` from [`scripts/lib/renovate-guardrails.ts`](node_modules/renovate-workflow/scripts/lib/renovate-guardrails.ts):
...
- Guardrails: [scripts/lib/renovate-guardrails.ts](node_modules/renovate-workflow/scripts/lib/renovate-guardrails.ts)
