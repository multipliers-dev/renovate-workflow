...
Use [`scripts/lib/renovate-policy-facts.ts`](node_modules/renovate-workflow/scripts/lib/renovate-policy-facts.ts) for deterministic package/path/threshold lookup in tests and tooling.
...
- Derive `stop_causes` with [`derive-stop-causes.ts`](node_modules/renovate-workflow/scripts/lib/derive-stop-causes.ts)
