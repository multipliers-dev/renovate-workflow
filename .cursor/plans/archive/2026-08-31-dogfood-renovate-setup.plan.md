...
- GitHub secret `RENOVATE_TOKEN` on `multipliers-dev/renovate-workflow` — fine-grained org PAT (not classic `repo`); first `workflow_dispatch` succeeded 2026-08-31 (https://github.com/multipliers-dev/renovate-workflow/actions/runs/33365600191)
